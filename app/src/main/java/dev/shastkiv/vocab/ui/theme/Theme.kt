...
val LocalCustomAppColors = staticCompositionLocalOf {
    CustomAppColors(
        ...
        dialogInfoBackground = Color.Unspecified,
        ...
        promoCardBackgroundGradient = SolidColor(Color.Unspecified),
        ...
        masteryBarGradientStart = Color.Unspecified,
        masteryBarGradientEnd = Color.Unspecified,
