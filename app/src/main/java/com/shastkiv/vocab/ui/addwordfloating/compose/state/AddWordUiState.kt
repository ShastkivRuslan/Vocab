...
sealed interface AddWordUiState {
    ...
    data class Success(
        ...
        val wordData: WordData?, // Повні дані для Premium
        val simpleTranslation: String?, // Тільки переклад для Free
    ...
    object ShowPaywall : AddWordUiState // Новий стан для показу діалогу про підписку
